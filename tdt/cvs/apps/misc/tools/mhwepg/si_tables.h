...
#if BYTE_ORDER == BIG_ENDIAN
   u_char                                        :4;
   u_char time_offset_info_length_hi             :4;
#else
   u_char time_offset_info_length_hi             :4;
   u_char                                        :4;
#endif
   u_char time_offset_info_length_lo             :8;
   // descriptors
} tot_t;
...
#define ITEM_LOCAL_TIME_OFFSET_LEN 13
typedef struct item_local_time_offset_struct {
...
} item_local_time_offset_t;
#define CastItemLocalTimeOffset(x) ((item_local_time_offset_t *)(x))
